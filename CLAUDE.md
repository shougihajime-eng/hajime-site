...
- ✅ 直近で済んだこと: Next.js 雛形作成 / GitHub リポジトリ / Vercel 公開URL発行
- 🟡 進行中: 実績データの正確性確認（本人ヒアリング中）／ YouTube・X リンク収集
- 🔜 次の一歩: 和風デザインのトップページに、確定した実績・サービス・SNS を流し込む
...
4. やっているサービス・教室: カード一覧
   ...
   - 青葉はじめ将棋教室（横浜市青葉区）— ※URL未確認
   - 両国将棋塾（両国将棋囲碁センター内、及川拓馬七段と共同）— ※URL未確認
